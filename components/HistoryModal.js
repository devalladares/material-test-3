    ...
    <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50 overflow-y-auto p-4">
      ...
      >
        <div className="flex items-center justify-between mb-4 px-1">
          <h2 className="text-xl font-medium text-gray-800" style={{ fontFamily: "'Google Sans Text', sans-serif" }}>Drawing History</h2>
          <button 
            type="button"
            onClick={onClose}
              ...
              >
                <div className="relative bg-black">
                  <img 
                    ...
                    style={{ aspectRatio: `${item.dimensions?.width || 1} / ${item.dimensions?.height || 1}` }}
                  />
                </div>
